...
CREATE TABLE `machine` (
  ...
  UNIQUE KEY `idMachine_UNIQUE` (`idMachine`),
  UNIQUE KEY `nameMachine_UNIQUE` (`nameMachine`)
...
INSERT INTO `machine` VALUES (3,'Estamparia'),(17,'Impressora'),(18,'Prensadora'),(5,'Torninho');
