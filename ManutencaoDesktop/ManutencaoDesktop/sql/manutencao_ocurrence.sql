...
CREATE TABLE `ocurrence` (
  `idOcurrence` int NOT NULL AUTO_INCREMENT,
  `descriptionOcurrence` longtext NOT NULL,
  `machineId` int DEFAULT NULL,
  PRIMARY KEY (`idOcurrence`),
  UNIQUE KEY `idOcurrence_UNIQUE` (`idOcurrence`),
  KEY `machineId_idx` (`machineId`),
  CONSTRAINT `machineIdOcurrence` FOREIGN KEY (`machineId`) REFERENCES `machine` (`idMachine`)
